"""
UNIFIED unit ledger v2 - RULING: the 2026-06-22 Rs18,451.51/176.389568-unit
mint-only entry to Manas is REMOVED. No recognized source for either the
mint itself or the [17798,17812] unit-count gate it was reverse-engineered
to satisfy (Mannu confirmed: gate does not ring a bell). Per instruction, NO
substitute mint or estimate is added in its place - the honest ledger has
no event on 2026-06-22.
 — rebuilds unit segregation onto Task 1a/1b's anchor
